...
def promote(update: Update, context: CallbackContext) -> str:
    ...
    bot.sendMessage(
        chat.id,
        f"Sucessfully promoted! Now Give Party!<b>{user_member.user.first_name or user_id}</b>!",
...
def demote(update: Update, context: CallbackContext) -> str:
    ...
    try:
        ...
        bot.sendMessage(
            chat.id,
            f"Demoted Successfully! Betterluck next time <b>{user_member.user.first_name or user_id}</b>!",
            parse_mode=ParseMode.HTML)
